...
// Check if the file is a URL or Base64 string
const isBase64PDF = true; // Set to true if you're using Base64, else set it to false
const filePath = '../../priority/Codes.pdf'; // If using a file, set this to the file path
const base64PDF = '...'; // If using Base64, paste your Base64 PDF string here

// Decide the URL based on the condition
let url;
if (isBase64PDF) {
    url = `data:application/pdf;base64,${base64PDF}`;
} else {
    url = filePath; // Use the path to the PDF file
}
