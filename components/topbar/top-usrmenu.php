<?php
    ...
    if ($_SESSION['user_id'] === 1) {
        $temp_img_test = $img_test1;
    } else {
        $temp_img_test = $img_test2;
    }
...
<div
    ...
    <div class="py-3 px-4">
        <center>
            <div id="imageContainer2" class="w-40 h-40 mt-5 mb-5 rounded-full border-8 border-gray-400">
                <!-- <p id="postName"></p> -->
                <img id="profileImage2" class="rounded-full" src="<?php echo $temp_img_test; ?>" alt="user photo" />
            </div>
        </center>
        <span
            class="block text-sm font-semibold text-gray-900 dark:text-white"><?php echo $user_name; ?></span>
        <span
            class="block text-sm text-gray-900 truncate dark:text-white"><?php echo $user_email; ?></span>
    </div>
    <ul
...
<?php
    ...
    if ($_SESSION['user_id'] >= 2) {
        echo '<script src="../../img/js/prof-pic-loop.js"></script>';
    }
