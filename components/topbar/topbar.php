    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="dashboard.php" class="flex items-center justify-between mr-4">
                ...
                <span class="self-center text-base text-2xs font-semibold whitespace-nowrap dark:text-white passviewer-text">
                    PassViewer
                </span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            include_once "top-notify.php";

            include_once "top-apps.php";

            include_once "top-usrmenu.php";
