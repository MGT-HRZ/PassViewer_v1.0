<?php
    ...
    if (isset($_GET['signout']) && $_GET['signout'] === md5('true')) {
        $input_success = $_GET['signout'];
        ...
        echo '
            <div>
                <!-- Modal Structure -->
                <div id="goodbyeModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50 hidden">
                    <div class="bg-white dark:bg-gray-800 rounded-[5%] border-4 border-gray-400 dark:border-gray-700 shadow-lg w-[375px] md:w-[500px] sm:w-[500px] mt-[1%] md:mt-[1%] mt-[1%] p-8">
                        ...
                        <div class="text-center">
                            <h1 class="text-3xl font-semibold text-gray-800 dark:text-gray-100">Good Bye & So Long!</h1>
                            <div class="mt-6">
                                ...
                                <!-- <p class="text-4xl font-semibold text-gray-700 dark:text-gray-300"><span class="text-blue-600"></span></p> -->
                            </div>
                            <p class="text-lg mt-4 text-gray-600 dark:text-gray-400">Hope, you will check on us again in the future.</p>
                            <div class="mt-6">
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        $("#goodbyeModal").removeClass("hidden").addClass("flex").hide().fadeIn(500); // Fade-in effect
                    });

                    // Close the modal when the close button is clicked with fade-out effect
                    $("#closeModal").click(function() {
                        $("#goodbyeModal").fadeOut(500, function() {
                    ...
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        fetch("../../img/data.json") // Ensure the correct path to your JSON file
                            ...
                            .then(data => {
                                ...
                                const profileImageEl_gbye = document.getElementById("pro-image");
                                if (!profileImageEl_gbye) {
                                    ...
                                    return new Promise(resolve => {
                                        ...
                                        function updateImage() {
                                            if (post[`img${imageIndex}`]) {
                                                profileImageEl_gbye.src = post[`img${imageIndex}`];
                                                profileImageEl_gbye.alt = `${post.name} - Image ${imageIndex}`;

                                                // Fade in the new image
                                                profileImageEl_gbye.style.transition = "opacity 1s";
                                                profileImageEl_gbye.style.opacity = 1;

                                                // After 2 seconds (image displayed), fade out the current image
                                                setTimeout(() => {
                                                    profileImageEl_gbye.style.opacity = 0;
